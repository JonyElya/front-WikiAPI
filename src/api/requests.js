...
export const ItemsAPI = {
  getArticle(input) {
    return instanceMyApi.get(`articles?title=${input}`).then((response) => {
      return response.data;
    });
  },
  getAll() {
    return instanceMyApi.get(`articles`).then((response) => {
      return response.data;
    });
  },
  create(values) {
...
export const articlesAPI = {
  getArticle(input) {
    return instance.get(input + "&format=json").then((response) => {
      return response.data;
    });
  },
};
